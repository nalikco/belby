...
func (s *Fotomix) Find(query string) (entities.Product, error) {
...
func (s *Fotomix) sort(products []entities.Product) ([]entities.Product, error) {
...
func (s *Fotomix) parse(response string) ([]entities.Product, error) {
	var products []entities.Product
